...
%
%    UPDATED ON: March 30th, 2016 at 11:00 PM
%
%    1D FTCS STAGGERED GRID NUMERICAL MODEL: CLEAR CREEK GLACIER
%    All of the code written inSI units
%
...
% valley width as a function of distance downvalley (approximated)
    ...
    W_min1 = 1000; % meters
    phi = 4; % importance of tributary widening, ~ 15 km? 
...
if rem(t(i),tplot)==0
    ...
    axis([minb bcap zmin-border zmax+border])
